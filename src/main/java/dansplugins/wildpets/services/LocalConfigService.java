...
public class LocalConfigService {
    ...
    public void saveMissingConfigDefaultsIfNotPresent() {
        ...
        EntityConfig defaultEntityConfig = LocalEntityConfigService.getInstance().getDefaultConfiguration();
        ...
        for (EntityConfig entityConfig : LocalEntityConfigService.getInstance().getDefaults()) {
